...
Devise.setup do |config|
  ...
  # config.secret_key = '6a8a02c7fcc9141df8e88db50af58e82401ce180630beb11045586e1afab3dfa10785b4982be5804b51bf49445ed0c79bbaf183d68b12e214c857a297268886a'
  ...
  # config.pepper = '15df44f270b67e170be872b8c3bdb2abff8d386fa4541d3bf4dff29441f740b475e71926479141a6b80bfee27eb127e65e7d9a3c36f94ab084bca585e37edd10'
  ...
  config.omniauth :twitter, ENV['TWITTER_API_KEY'], ENV['TWITTER_API_SECRET'], scope: 'email', oauth_callback: "https://dokusyo-no-wa.com/users/auth/twitter/callback"
